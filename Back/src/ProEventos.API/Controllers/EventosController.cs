    ...
    public class EventosController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ...
                if (eventos == null) return NotFound("Eventos nenhum foi encontrado!");
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                if (evento == null) return NotFound("Evento não encontrado por ID");
        ...
        public async Task<IActionResult> GetByTema(string tema)
        {
            try
            {
                ...
                if (eventos == null) return NotFound("Eventos não encontrado por TEMA");
